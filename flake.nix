  ...
  in {
    ...
    packages.default = pkgs.stdenv.mkDerivation {
      ...
      installPhase = ''
        ...
        cp "Miracode.ttf" "$out/Miracode.ttf"
        ...
        createThumbnail() {
          ...
          ${pkgs.imagemagick}/bin/magick -size 1200x800 xc:#0000ff \
            -font Miracode.ttf -gravity Center -pointsize 72 \
        ...
        buildMainPage() {
          ...
          cat "about.html" |
            ...
            ${hljs}/bin/hljs --s=".code-hl"   >> "$out/index.html"
        ...
        buildBlogPost() {
          ...
          echo '<div id="markdown-content">'    >> "$out/b/$1/index.html"
          ${marked}/bin/marked -c "marked.js" |
            ${hljs}/bin/hljs --s=".code-hl"     >> "$out/b/$1/index.html"
